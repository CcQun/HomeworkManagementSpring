...
<head>
    ...
    <script>
        function display(id) {
            ...
            let homeworkMsg = document.getElementById("homeworkMsg")
            homeworkMsg.submit()
        }
    </script>
</head>
<body>
<form id="homeworkMsg" method="post" action="${pageContext.request.contextPath}/hms/querySpecificHomework">
    ...
    <table align="center" width="960" border="1">
        ...
        <%
            List<Homework> list = (List<Homework>) request.getAttribute("allHomeworkList");
        ...
        <tr>
            ...
            <td><input type="button" width="100%" value="作业提交详情" onclick="display(<%=homework.getId()%>)"></td>
        </tr>
        <%
                }
            }
